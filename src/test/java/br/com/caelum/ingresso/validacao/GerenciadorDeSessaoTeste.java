...
public class GerenciadorDeSessaoTeste {
	...
	@Test
	public void garateQueNaoDevePermitirSesssoesTerminandoDentroDoHorarioDeUmaSessaoJaExistente(){
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
	...
	@Test
	public void garateQueNaoDevePermitirSesssoesIniciadnoDentroDoHorarioDeUmaSessaoJaExistente(){
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().minusHours(1),rogueOne,sala3D);
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
		Assert.assertFalse(gerenciador.cabe(sessao));
